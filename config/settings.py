...
INSTALLED_APPS = [
    ...
    'heladeria',  # Nuestra aplicación de la heladería
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DATABASE_NAME', default='heladeria_db'),
        'USER': config('DATABASE_USER', default='heladeria'),
...
AUTH_USER_MODEL = 'heladeria.Usuario'
